...
<img src="figs/exercise_test_perf.png" alt="Performance on exercise testing" width="280" style="float: left; margin-right: 20px; margin-bottom: 20px;">
...
<img src="figs/HRt_vs_HRMax.png" alt="Exercise test HRt vs 50% of HRmax" width="500" style="float: right; margin-left: 20px; margin-bottom: 20px;">
...
<img src="figs/official_tree.jpg" alt="Decision tree" width="400" style="float: left; margin-right: 20px; margin-bottom: 20px;">
...
<img src="figs/mrspect.png" alt="MRSpectroscopy brain metabolites" width="500" style="float: right; margin-left: 20px; margin-bottom: 20px;">
...
<img src="figs/wtmean_ensem_preds.jpg" alt="Weighted mean of model predictions - ensemble" width="280" style="float: left; margin-right: 20px; margin-bottom: 20px;">
